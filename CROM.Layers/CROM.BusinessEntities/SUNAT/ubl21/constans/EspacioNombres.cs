namespace CROM.BusinessEntities.SUNAT.ubl21.constans
{
    public static class EspacioNombres
    {
        ...
        public const string ext = "urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2:UBLExtensions";
