...
{
    public class BEDocumentoSUNATCargoDescuentoResponse
    {
        public BEDocumentoSUNATCargoDescuentoResponse()
        {
        ...
        public string keyRegMonedaMontoItem { get; set; }

        public decimal mtoItem { get; set; }

        public string codRegMonedaBaseImpon { get; set; }

        public string keyRegMonedaBaseImpon { get; set; }
